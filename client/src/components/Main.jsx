...
const Main = () => {
    ...
    const { connectWallet, currentAccount, formData, sendTransaction, handleChange, balance, isLoading } =
        useContext(Context);
            ...
            <div className="flex md:flex-row items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col md:mr-10">
                    ...
                    <p className="dark:text-gray-300 text-left mt-4 text-black md:w-9/12 w-11/12 dark:font-thin italic">
                        *This app includes a visual walkthrough and other a few features to help you understand how to create a live
                        crypto transaction*
                    </p>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10 pl-4">
                    ...
                    <div className="flex flex-col flex-1 items-center justify-start w-full" id="eight">
                        <p className="text-black text-sm dark:text-gray-300">Address: {address}</p>
                    ...
                    <div
                        className="text-black p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism"
                        id="ten"
                    >
