        ...
        <div>
            <div className="grid sm:grid-cols-4 grid-cols-3 w-full mt-10" id="seven">
                <p className="dark:text-gray-300 text-left text-black">
                    <AiOutlineInfoCircle
                        fontSize={18}
                        className="text-black float-right dark:text-gray-300 mx-2 mt-1 cursor-pointer"
                        data-tooltip-target="tooltip-dark4"
                    />
                    <div id="tooltip-dark4" role="tooltip" className={tooltipStyle}>
                        The Chain ID is a value used to identify which network the transaction was sent on. (1=Mainnet, 3=Ropsten,
                        4=Rinkeby, 5=Goerli, 42=Kovan)
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark5" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark6" role="tooltip" className={tooltipStyle}>
                        A TxHash or transaction hash is a unique 66-character identifier that is generated whenever a transaction is
                        executed.
                        <div className="tooltip-arrow" data-popper-arrow />
                    </div>
                    TxID:
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark7" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark8" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark9" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    <AiOutlineInfoCircle
                        fontSize={18}
                        className="text-black float-right dark:text-gray-300 mx-2 mt-1 cursor-pointer"
                        data-tooltip-target="tooltip-dark10"
                    />
                    <div id="tooltip-dark10" role="tooltip" className={tooltipStyle}>
                        The value being transacted in Ether and fiat value. Note: You can click the fiat value (if available) to see
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark11" role="tooltip" className={tooltipStyle}>
                        Additional data included for this transaction. Commonly used as part of contract interaction or as a message
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark12" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark13" role="tooltip" className={tooltipStyle}>
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark14" role="tooltip" className={tooltipStyle}>
                        The amount of ETH that will be burnt (destroyed) for the transaction. The suggested minimum amount of gas
                ...
                <p className="dark:text-gray-300 text-left text-black">
                    ...
                    />
                    <div id="tooltip-dark15" role="tooltip" className={tooltipStyle}>
